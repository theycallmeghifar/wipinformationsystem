...
<div class="content-wrapper">
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Line Machining</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            ...
                            <div class="d-flex align-items-center pull-right">
                                <select name="statusU" id="statusU" class="form-control form-control-user" style="width: 180px;margin-top: 10px;margin-right: 5px">
                            ...
                            <form id="formExportExcel" target="_blank" method="post" role="form" action="<?php echo site_url('Lokasi/ExportExcelLocationCon') ?>">
                ...
                <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="tambahData" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" >
                        <div class="modal-content">
                            ...
                            <form role="form" action="<?php echo site_url('Lokasi/saveLocationCon')?>" method="post" autocomplete="off">
                ...
                <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" >
                        <div class="modal-content">
                            ...
                            <form role="form" action="<?php echo site_url('Lokasi/updateLocationCon')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                <div class="modal-body" style="width: 410px;">
...
<!-- IMPORT DATA -->
                <div class="modal fade" id="importData" tabindex="-1" role="dialog" aria-labelledby="tambahData" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                        <form action="<?php echo base_url('Lokasi/importExcelLocationCon') ?>" method="POST" enctype="multipart/form-data">
                            <div class="modal-content">
                                <div class="modal-header">

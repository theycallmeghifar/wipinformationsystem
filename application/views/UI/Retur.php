                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="dataTable" data-order='[[7, "asc"]]' class="display nowrap table-striped table" style="width:100%" >
                                ...
                                <tbody>
                                <?php foreach($readyRetur as $data){ ?>
                                    <tr>                             
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="ion-arrow-return-left color-muted detailbtn" title="Retur" style="margin-left: 15px;"></a>
                                        </td>
        ...
        $(document).ready(function(){
            ...
            $('#addModal').on('shown.bs.modal', function () {
                ...
                if (loc == "Finishing") {
                    ...
                    var newOption = `<option value="Machining">Machining</option>`;
                    $("#location").append(newOption);
                } else {
                    var newOption = `<option value="WIP">WIP</option>
                                        <option value="Finishing">Finishing</option>`;

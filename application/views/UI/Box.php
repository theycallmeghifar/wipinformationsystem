            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Master Barang</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-0">
                            ...
                            <form id="formPrint" target="_blank" method="post" role="form" action="<?php echo site_url('QrCodeCon/qrCodeBoxCon') ?>">
                            ...
                            <form id="formExportExcel" target="_blank" method="post" role="form" action="<?php echo site_url('Box/ExportExcelBoxCon') ?>">
                                <button class="btn btn-success pull-left" style="margin-top: 10px; margin-right: 5px;" id="btnExportExcel" type="button" class="btn btn-info">
                ...
                <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="tambahData" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" >
                        <div class="modal-content">
                            ...
                            <form role="form" action="<?php echo site_url('Box/saveBoxCon')?>" method="post" autocomplete="off">
                                <div class="modal-body" style="width: 410px;">
                                    <div class="form-group row align-items-center">
                                        <label class="col-sm-5 col-form-label text-label">Kode Box<span style="color: red">*</span></label>
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                                <input type="text" id="boxCode" name="boxCode" class="form-control form-control-user" required></input>
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center">
                                        <label class="col-sm-5 col-form-label text-label">Warna Box<span style="color: red">*</span></label>
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                            <select name="boxColor" id="boxColor" class="form-control form-control-user" style="width: 180px;">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label class="col-sm-5 col-form-label text-label">Kapasitas<span style="color: red">*</span></label>
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                                <input type="number" id="capacity" name="capacity" class="form-control form-control-user" placeholder="Hanya angka" required min="1"></input>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row match-height">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                    <input type="number" id="capacityU" name="capacityU" class="form-control form-control-user" placeholder="Hanya Angka" required min="1"></input>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row align-items-center">
                            ...
                            <div class="modal-body" style="width: 410px;">
                                <div class="row match-height">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label class="col-sm-5 col-form-label text-label">Warna Box</label>
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label class="col-sm-5 col-form-label text-label">Kapasitas</label>
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label class="col-sm-5 col-form-label text-label">Status Penggunaan</label>
                                            <div class="col-sm-7">
                                                <div class="input-group">
...
<!-- end DETAIL DATA-->
<!-- IMPORT DATA -->
                <div class="modal fade" id="importData" tabindex="-1" role="dialog" aria-labelledby="tambahData" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.detailbtn').on('click', function(){
                ...
                $('#usageStatusD').val(data[3]);
                $('#statusD').val(data[6]);
                $('#createdDateD').val(data[7]); 
                $('#modifiedDateD').val(data[8]); 
            });
        });

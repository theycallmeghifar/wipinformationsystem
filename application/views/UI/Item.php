                            ...
                            <form role="form" action="<?php echo site_url('Item/saveItemCon')?>" method="post" autocomplete="off">
                                <div class="modal-body" style="width: 410px;">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                                <input type="text" id="cavity" name="cavity" class="form-control form-control-user"></input>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row match-height">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                    <input type="text" id="cavityU" name="cavityU" class="form-control form-control-user"></input>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row align-items-center">
                                    ...
                                    <div class="row match-height">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                    <input type="text" id="cavityD" name="cavityD" class="form-control form-control-user"disabled></input>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row align-items-center">

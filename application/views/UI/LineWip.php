...
<div class="content-wrapper">
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Jalur WIP</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Menu</a></li>
                        <li class="breadcrumb-item active">Master Lokasi</a></li>
                        <li class="breadcrumb-item active">Jalur WIP</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="row" style="margin-left:20px;">
                            <form id="formExportExcel" target="_blank" method="post" role="form" action="<?php echo site_url('LineWip/ExportExcelLocationCon') ?>">
                                <button class="btn btn-success pull-left" style="margin-right:5px;" id="btnExportExcel" type="submit">
                                    <i style="margin-right: 8px;" class="fas fa-arrow-up"></i>Export Excel
                                </button>
                            </form>
                            <button class="btn btn-success pull-left" id="btnImport" type="button" class="btn btn-info" data-toggle="modal" data-target="#importData"><i style="margin-right: 8px;" class="fas fa-arrow-down"></i>Import Excel</button>
                        </div>
                        <div class="card-body">
                            <table id="dataTable" class="display nowrap table-striped table" style="width:100%" >
                                ...
                                <tbody>
                                    ...
                                    <tr>                             
                                        ...
                                        <td hidden="true"><?php echo $data->location?></td>
                ...
                <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="tambahData" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" >
                        <div class="modal-content">
                            ...
                            <form role="form" action="<?php echo site_url('LineWip/saveLocationCon')?>" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                                <input type="text" id="line" name="line" class="form-control form-control-user" value="Jalur " required></input>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" >
                        <div class="modal-content">
                            ...
                            <form role="form" action="<?php echo site_url('LineWip/updateLocationCon')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                <div class="modal-body" style="width: 410px;">
                                ...
                                <div class="row match-height">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                <input type="text" id="locationD" name="locationD" class="form-control form-control-user" disabled></input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            <label class="col-sm-5 col-form-label text-label">Line</label>
                                            <div class="col-sm-7">
                                                <div class="input-group">
...
<!-- IMPORT DATA -->
                <div class="modal fade" id="importData" tabindex="-1" role="dialog" aria-labelledby="tambahData" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                        <form action="<?php echo base_url('LineWip/importExcelLocationCon') ?>" method="POST" enctype="multipart/form-data">
                            <div class="modal-content">
                                <div class="modal-header">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.detailbtn').on('click', function(){
                ...
                $('#locationIdD').val(data[0]);
                $('#locationD').val(data[4]);
                $('#lineD').val(data[1]);
                $('#statusD').val(data[5]);

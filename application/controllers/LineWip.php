    ...
    class LineWip extends CI_Controller {
        ...
        {
            $getData["getData"] = $this->model_Location->getWipLocationMod();
            $this->load->view('UI/LineWip', $getData);
        }
        ...
        {
            $data = $this->model_Location->getWipLocationMod();
